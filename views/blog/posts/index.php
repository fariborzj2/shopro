            ...
            <?php foreach ($posts as $post): ?>
                <tr>
                    ...
                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm text-center">
                        <a href="/blog/posts/edit/<?= $post['id'] ?>" class="text-indigo-600 hover:text-indigo-900 mr-4">ویرایش</a>
                        <form action="/blog/posts/delete/<?= $post['id'] ?>" method="POST" class="inline-block" onsubmit="return confirm('آیا از حذف این نوشته مطمئن هستید؟');">
