<div class="max-w-6xl mx-auto">
    <!-- Header -->
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">ویرایش مدیر</h1>
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">ویرایش اطلاعات و دسترسی‌های <?= htmlspecialchars($admin['name']) ?></p>
    </div>

    <form action="<?php echo url('/admin/admins/update/' . $admin['id']); ?>" method="POST">
