<div class="bg-white dark:bg-gray-800 rounded-2xl shadow-card border border-gray-100 dark:border-gray-700 overflow-hidden">
    ...
    <div class="grid grid-cols-1 gap-4 md:hidden px-4 pb-4">
        <?php if(!empty($orders)): ?>
            <?php foreach($orders as $order): ?>
                <div class="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4 border border-gray-100 dark:border-gray-700">
                    ...
                    <div class="mb-3 text-sm">
                        <span class="text-gray-500 dark:text-gray-400">محصول:</span>
                        <span class="font-medium text-gray-800 dark:text-gray-200"><?php echo htmlspecialchars($order->product_name); ?></span>
                    </div>
