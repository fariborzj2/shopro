<div class="flex justify-between items-center mb-6">
    <h1 class="text-3xl font-bold">مدیریت دسته‌بندی‌ها</h1>
    <a href="/categories/create" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
        ...
        <tbody>
            <?php foreach ($categories as $category): ?>
                <tr>
                    ...
                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                        <p class="text-gray-900 whitespace-no-wrap"><?= htmlspecialchars($category['name_en']) ?></p>
                    </td>
                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
