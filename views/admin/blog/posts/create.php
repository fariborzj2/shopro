<?php partial('admin/header', ['title' => 'Create Blog Post']) ?>
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h1>Create Blog Post</h1>
            <form action="/admin/blog/posts/store" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="faq_items[]" id="faq_items" class="form-control" multiple>
                        <?php foreach ($all_faq_items as $faq_item) : ?>
                            <option value="<?= $faq_item['id'] ?>"><?= $faq_item['question'] ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="form-group form-check">
                    <input type="checkbox" class="form-check-input" id="is_editors_pick" name="is_editors_pick" value="1">
