    ...
    <div class="min-h-screen flex flex-col items-center justify-center px-4">
        <div class="max-w-2xl w-full text-center">
            ...
            <?php if ($isDebug && $debug_info): ?>
                <div class="mt-12 text-left bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <p class="mt-1 p-2 bg-gray-50 dark:bg-gray-700 rounded-md text-sm font-mono"><?= htmlspecialchars($debug_info['message']) ?></p>
                        </div>
                        <div>
                            <strong class="block text-gray-700 dark:text-gray-300">فایل:</strong>
                            <p class="mt-1 p-2 bg-gray-50 dark:bg-gray-700 rounded-md text-sm font-mono"><?= htmlspecialchars($debug_info['file']) ?> (خط <?= htmlspecialchars($debug_info['line']) ?>)</p>
                        </div>
                        <div>
                            <strong class="block text-gray-700 dark:text-gray-300">Stack Trace:</strong>
                            <pre class="mt-1 p-3 bg-gray-50 dark:bg-gray-700 rounded-md text-xs font-mono overflow-x-auto custom-scrollbar"><?= htmlspecialchars($debug_info['trace']) ?></pre>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
