...
<div class="bg-white shadow-md rounded-lg p-8">
    <form action="<?php echo url('/users/store') ?>" method="POST"  enctype="multipart/form-data" accept-charset="UTF-8">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="<?php echo url('/users') ?>" class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800">
                انصراف
            </a>
        </div>
    </form>
