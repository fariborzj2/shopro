<div class="max-w-2xl mx-auto">
    <!-- Header -->
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">افزودن کاربر جدید</h1>
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">اطلاعات کاربر جدید را وارد کنید.</p>
    </div>
