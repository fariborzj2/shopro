    ...
    <div class="section pd-td-40 hero">
        <div class="center">
            <div class="hero-info text-center max-w600 m-auto relative">
                ...
                <div class="color-bright"><span class="icon-calendar-2 gr-text font-size-1-5"></span> وبلاگ ما</div>
                <h1 class="title-size-1">اخبار و <span class="gr-text">مقالات</span></h1>
                <p class="font-size-1-1">
                    جدیدترین ترفندها، اخبار و آموزش‌های دنیای تکنولوژی را اینجا بخوانید.
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="center">
            ...
            <?php if (empty($posts)): ?>
                <div class="text-center py-5">
                    <p class="font-size-1-5 purple-gray">مطلبی یافت نشد.</p>
                </div>
            <?php else: ?>
