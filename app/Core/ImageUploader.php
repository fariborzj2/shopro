...
class ImageUploader
{
    ...
    public function upload(array $file, string $subDirectory = '', string $baseDir = 'uploads'): ?string
    {
        ...
        // Construct the base upload directory (relative to public)
        $baseDir = trim($baseDir, '/');
        $uploadRoot = PROJECT_ROOT . '/public/' . $baseDir . '/';
        ...
        if (move_uploaded_file($file['tmp_name'], $uploadPath)) {
            ...
            return '/' . $baseDir . '/' . (!empty($subDirectory) ? rtrim($subDirectory, '/') . '/' : '') . $newFileName;
        }
